<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EmpEdit.aspx.cs" Inherits="EmpEdit" Title="修改雇员" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content1" Runat="Server">
    <div id="childmenu">
        <a class="menu" href="emplist.aspx">返回列表</a>
    </div>
    <asp:FormView ID="frm1" runat="server" DataKeyNames="id" DataSourceID="Data1"
        DefaultMode="Edit" OnDataBound="frm1_DataBound">
        <HeaderTemplate>
        ...
        <FooterTemplate>
            <table id="edit_footer" align="center" cellpadding="4" cellspacing="0">
                <tr id="editcmd">
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text=" 保存 " CommandName="Update"></asp:Button>&nbsp;
            ...
            <table id="edit_form" align="center" cellpadding="4" cellspacing="0">
                <tr>
                    <td class="edittitle">
                        雇员编号：</td>
                    <td class="textvalue">
                        <asp:TextBox ID="txtEmpID" runat="server" require="1" errmsg="请输入雇员编号" Width="180px" Text='<%# Bind("ID") %>' MaxLength="9" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="edittitle">
    ...
    <asp:ObjectDataSource ID="Data1" runat="server" SelectMethod="GetEmployInfo"
        TypeName="EmployeeAgent" UpdateMethod="UpdateEmployee"  DataObjectTypeName="Employee" OnUpdating="Data1_Updating" OnUpdated="Data1_Updated">
        <SelectParameters>
