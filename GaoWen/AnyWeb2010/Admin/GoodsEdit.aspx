...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
            ...
            $.ajaxFileUpload(
                   {
                       ...
                       dataType: 'jsons',                                     //服务器返回的格式，可以是json
    ...
    <div>
        <ul class="Help">
            <li>图片应小于500k，jpg或gif格式。建议为<%=AnyWeb.AW.Configs.GeneralConfigs.GetConfig().GoodsImageWidth%>x<%=AnyWeb.AW.Configs.GeneralConfigs.GetConfig().GoodsImageHeight%>像素。</li>
