...
var _VersionInfo="Version:2005 作者:Earth"	//版本信息

//==================================================== WEB 页面显示部分 =====================================================
var strFrame;		//存放日历层的HTML代码
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute;  z-index: 9998; display: none" width="190" height="240"></iframe>');
strFrame='<style>';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=188 height=160 bordercolor=#ff9900 bgcolor=#ff9900 Author="wayx">';
...
strFrame+='        <td colspan=3 align=right Author=meizz><span onclick=parent.cleardates() style="font-size:12px;cursor: hand"';
strFrame+='         Author=meizz title="' + _VersionInfo + '"><u>清除</u></span>&nbsp;<span onclick=parent.closeLayer() style="font-size:12px;cursor: hand" Author=meizz title="' + _VersionInfo + '"><u>关闭</u></span></td></tr>';
