            ...
            <div class="mbd">
                ...
                <div class="fi">
                    <label>
                        支付方式：</label>
                    <div class="cont">
                        <input name="rdPayMode" type="radio" value="4" />货到付款
                        ...
                        <input name="rdPayMode" type="radio" value="3" />银行转帐/电汇 &nbsp;&nbsp;&nbsp;<span
                            id="msg_payMode" class="msg"></span>
                    </div>
                </div>
                <div class="fi even">
                    <label>
                    ...
                    <div class="cont">
                        ...
                        <input name="rdDeliverMode" type="radio" value="4" />自提
                        <input name="rdDeliverMode" type="radio" value="5" />配送&nbsp;&nbsp;&nbsp;<span id="msg_deliverMode"
                            class="msg"></span>
                    </div>
                </div>
                <div class="fi">
