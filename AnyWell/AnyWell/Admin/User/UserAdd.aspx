<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/InnerContent.master"
    AutoEventWireup="true" CodeFile="UserAdd.aspx.cs" Inherits="Admin_User_UserAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAccount" runat="server" Width="150" CssClass="text" MaxLength="50"></asp:TextBox>
                <sw:Validator ID="Validator2" ControlID="txtAccount" ValidateType="Required" ErrorMessage="请填写用户帐号"
                    runat="server">
                </sw:Validator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <sw:Validator ID="Validator3" ControlID="txtPassword" ValidateType="Required" ErrorMessage="请填写原密码"
                    runat="server">
                </sw:Validator>
                <sw:Validator ID="Validator7" ControlID="txtPassword" ValidateType="MinLength" ErrorMessage="密码长度必须大于6位"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPassword2" runat="server" TextMode="Password" Width="150" CssClass="text"
                    MaxLength="16"></asp:TextBox>
                <sw:Validator ID="Validator8" ControlID="txtPassword2" Expression="checkPassword();" ValidateType="Custom" CheckBlur="true" ErrorText="确认密码和新密码不一样" ErrorMessage="确认密码和新密码不一样" runat="server"></sw:Validator>
            </td>
        </tr>
        <tr>
            <th>
