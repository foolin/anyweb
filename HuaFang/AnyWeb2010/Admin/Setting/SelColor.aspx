...
<head>
    ...
    <script language="JavaScript">
        ...
        document.write("<TITLE>颜色选择</TITLE>");
    ...
    <script type="text/javascript">
        $(function() {
            $("#ColorTable td").mouseover(function() {
                $("#RGB").html($(this).attr("bgColor"));
                EndColor();
            });
            $("#ColorTable td").mouseout(function() {
                $("#RGB").html(SelRGB);
                EndColor();
            });
            $("#ColorTable td").click(function() {
                SelRGB = $(this).attr("bgColor");
                EndColor();
            });
            $("#GrayTable td").mouseover(function() {
                $("#GRAY").html($(this).attr("title"));
                EndColor();
            });
            $("#GrayTable td").mouseout(function() {
                $("#GRAY").html(SelGRAY);
                EndColor();
            });
            $("#GrayTable td").click(function() {
                SelGRAY = $(this).attr("title");
                EndColor();
            });
            $("#Ok").click(function() {
                color = $("#SelColor").val();
...
<body bgcolor="#1ABDE6" onload="InitDocument()">
    <div align="center">
        <center>
		...
		(cnum[n3 + 2] * n1 + cnum[n2 + 2] * (5 - n1)), i);
                        ...
                        <td height="100%">
                            <table border="0" cellpadding="0" cellspacing="0" id="GrayTable" height="100%" style="cursor: hand">
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="2">
                            ...
                            代码:
                            <input id="SelColor" size="7" value="">
                        </td>
                        <td>
