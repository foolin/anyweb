...
public partial class Admin_GoodsEdit : PageAdmin
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        goods = (new AW_Goods_dao()).funcGetGoodsInfo(int.Parse(QS("id")));
        ...
        else if (category.Parent != null && category.Parent.Parent != null)//第三级
        {
            ...
            if (item != null) item.Selected = true;
            drpCategory3.DataSource = category.Parent.Children;
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        using (AW_Goods_dao dao = new AW_Goods_dao())
        {
            ...
            this.AddLog( EventType.Update, "修改商品", "修改商品[" + goods.fdGoodName + "]" );
