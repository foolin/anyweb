...
public partial class Admin_Plugins_Subscribe_SubscribeList : PageAdmin
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int recordCount = 0;
        List<AW_Subscribe_bean> list = new AW_Subscribe_dao().funcGetSubscribeList(int.Parse(drpSite.SelectedValue), PN1.PageIndex, PN1.PageSize, out recordCount);
        if (list.Count > 0)
        {
