...
public partial class Head : AdminBase
{
    ...
    protected void ods3_Updated(object sender , ObjectDataSourceStatusEventArgs e)
    {
        ...
        {
            this.AddLog( Common.Common.EventID.Update , "修改页头信息" , "修改页头信息" );

            WebAgent.SuccAndGo( "保存成功." , "Head.aspx" );
        }
        else
        {
            WebAgent.FailAndGo( "保存失败." , "Head.aspx" );
        }
    }
