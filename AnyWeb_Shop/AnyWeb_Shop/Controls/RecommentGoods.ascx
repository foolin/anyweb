        ...
        <ItemTemplate>
            <div class="goods">
                <dl>
                    ...
                    <%# 
                        (bool)Eval("IsPromotions") ? ((double)Eval("Price") == 0 ? "<dd>促销价格：￥" + Eval("PromotionsPrice") + "元</dd>" : "<dd>商城优惠价：<s>￥" + Eval("Price") + "元</s></dd>" + "<dd>促销价格：￥" + Eval("PromotionsPrice") + "元</dd>") : ((double)Eval("Price") == 0 ? "" : "<dd>商城优惠价：￥" + Eval("Price") + "元</dd>")
                    %>
                </dl>
            </div>
            <!-- goods end -->
