...
namespace Studio.Data
{
	...
	public class SqlDbExecutor : IDbExecutor
	{
        ...
        public int ExecuteNonQuery(string commandText, IDbConnection Connection)
        {
        ...
        public int ExecuteSql(string commandText, IDbDataParameter[] parameters, IDbConnection Connection)
        {
            SqlConnection conn = (SqlConnection)Connection;
            SqlCommand cmd = new SqlCommand(commandText, conn);
            cmd.CommandTimeout = 180;
        ...
        public int ExecuteNonQuery(string procedureName, IDbDataParameter[] parameters, IDbConnection Connection)
        {
            SqlConnection conn = (SqlConnection)Connection;
