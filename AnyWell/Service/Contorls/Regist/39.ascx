<%@ Control Language="C#" AutoEventWireup="true" CodeFile="39.ascx.cs" Inherits="Contorls_Regist_39" %>
<h2 class="tit lblue">
...
<div class="conBox lh18">
    ...
    <p class="lh24 lblue">
        <strong>Dear
            <%=bean.fdRegiAppellation == 1 ? "Mr." : bean.fdRegiAppellation == 2 ? "Mrs." : bean.fdRegiAppellation == 3 ? "Miss." : "Ms."%>
            <%=bean.fdRegiName %>
            <%=bean.fdRegiSurname %>,</strong></p>
    <p>
