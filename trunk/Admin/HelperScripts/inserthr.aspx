...
<LEGEND align=left><strong>输入水平线参数</strong></LEGEND>
      <table border="0" cellpadding="0" cellspacing="3">
        <tr> 
          <td>线条颜色：
            <input name="color" id=color style='cursor:text' onclick='p=showModalDialog("color.aspx",window,"center:yes;dialogHeight:320px;dialogWidth:300px;help:no;status:no");if(p!=null){this.value=p.split("*")[0]}else{this.value=""}' readonly>
          </td>
        </tr>
        <tr>
          <td>线条粗度：
