...
<FIELDSET align=left>
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="3">
        ...
        <tr> 
          ...
          <td><input name="color" id=color2 onClick='p=showModalDialog("color.aspx",window,"center:yes;dialogHeight:320px;dialogWidth:300px;help:no;status:no");if(p!=null){this.value=p.split("*")[0]}else{this.value=""}' size="20" maxlength="20" readonly></td>
        </tr>
        <tr>
          <td align="right">背景颜色：          </td>
          <td><input name="backcolor" id=backcolor2 onClick='p=showModalDialog("color.aspx",window,"center:yes;dialogHeight:320px;dialogWidth:300px;help:no;status:no");if(p!=null){this.value=p.split("*")[0]}else{this.value=""}' size="20" maxlength="20" readonly></td>
        </tr>
      </table>
</FIELDSET>
