                ...
                <div class="mbd">
                    ...
                    <div class="fi group" style="border: 1px solid #ccc; margin-bottom: 5px;">
                        ...
                        <div class="fi">
                            <label>
                                收货地址：</label>
                            <%=AnyWell.Configs.AreaConfigs.GetConfigs().funcGetProvinceById(this.Order.fdOrdeUserProvinceID).Name+"省"
                                +AnyWell.Configs.AreaConfigs.GetConfigs().funcGetProvinceById(this.Order.fdOrdeUserProvinceID).funcGetCityById(this.Order.fdOrdeUserCityID).Name+"市"%><%=AnyWell.Configs.AreaConfigs.GetConfigs().funcGetProvinceById(this.Order.fdOrdeUserProvinceID).funcGetCityById(this.Order.fdOrdeUserCityID).funcGetAreaById(this.Order.fdOrdeUserAreaID)!=null?AnyWell.Configs.AreaConfigs.GetConfigs().funcGetProvinceById(this.Order.fdOrdeUserProvinceID).funcGetCityById(this.Order.fdOrdeUserCityID).funcGetAreaById(this.Order.fdOrdeUserAreaID).Name+"区":""%><%=this.Order.fdOrdeUserAddress %>
                        </div>
                        <div class="fi">
                            <label>
                                邮编：</label>
