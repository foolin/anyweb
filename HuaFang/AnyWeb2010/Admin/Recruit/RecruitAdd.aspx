    ...
    <div class="Mod Form MainForm" id="InfoEdit">
        ...
        <div class="mbd">
            ...
            <div class="fi">
                <label>
                    地区：</label>
                <asp:TextBox ID="txtAreaName" MaxLength="10" Width="400px" runat="server" CssClass="text"></asp:TextBox>
                <span class="required">*</span>
                <sw:Validator ID="Validator2" ControlID="txtAreaName" ValidateType="Required" ErrorText="请输入地区"
                    ErrorMessage="请输入地区" runat="server">
                </sw:Validator>
            </div>
            <div class="fi even">
                <label>
