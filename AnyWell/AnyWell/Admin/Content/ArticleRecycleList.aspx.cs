...
public partial class Admin_Content_ArticleRecycleList : PageAdmin
{
    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        int recordCount = 0;
        List<AW_Article_bean> list = new AW_Article_dao().funcGetArticleRecycleList( CurrentColumn, getChildren, field, orderBy, PN1.PageIndex, PN1.PageSize, out recordCount );
        if( list.Count == 0 )
        {
