...
<script runat="server">
    ...
    string[] urls = { "/", "/index.aspx", "/login.aspx", "/import.aspx", "/User/Index.aspx", "/logout.aspx", "/search.aspx", "/initarea.aspx", "/register.aspx", "/notice.aspx", "/addfavorite.aspx", "/recruitlist.aspx", "/getpassword.aspx", "/resetpwd.aspx", "/test.aspx" };
