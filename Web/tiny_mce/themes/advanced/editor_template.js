	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_buttons1 : "ormatselect,fontselect,fontsizeselect,forecolor,backcolor,|,bold,italic,underline,sub,sup,strikethrough,advhr,charmap,|,link,unlink,anchor,pagebreak",
