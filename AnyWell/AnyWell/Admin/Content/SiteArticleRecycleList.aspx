<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/List.master" AutoEventWireup="true"
    CodeFile="SiteArticleRecycleList.aspx.cs" Inherits="Admin_Content_SiteArticleRecycleList" %>

<%@ Register Src="../Control/SiteRecycleOperation.ascx" TagName="SiteRecycleOperation"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphOpr" runat="Server">
    <uc1:SiteRecycleOperation runat="server" />
