...
public partial class Admin_Content_ArticleSearch : PageAdmin
{
    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        else
        {
            ...
            int recordCount = 0;
            List<AW_Article_bean> list = new AW_Article_dao().funcSearchArticle( CurrentColumn, key, from, to, type, getChildren, field, orderBy, PN1.PageIndex, PN1.PageSize, out recordCount );
            if( list.Count > 0 )
            {
