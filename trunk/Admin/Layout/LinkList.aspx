<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LinkList.aspx.cs" Inherits="Layout_LinkList" Title="用户列表" %>
                    ...
                    <asp:Repeater ID="imgLink" runat="server">
                        <ItemTemplate>
                            <tr onmouseover="this.style.background='#E6F2FF';" onmouseout="this.style.background='#FFFFFF'">
                                ...
                                <td>
                                    <a href="<%#Eval("LinkUrl") %>" target="_blank"><img src="<%#Eval("LinkImage")%>" class="img" alt="<%#Eval("LinkName")%>" /></a></td>
                                <td>
                                    <%#Eval("LinkUrl") %></td>
                                <td>
                                    <%#Eval("LinkSort") %></td>
