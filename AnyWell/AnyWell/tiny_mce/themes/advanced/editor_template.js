    ...
    tinymce.create('tinymce.themes.AdvancedTheme', {
        ...
        init: function(ed, url) {
            ...
            t.settings = s = extend({
                ...
                theme_advanced_buttons1: "ormatselect,fontselect,fontsizeselect,lineheight,forecolor,backcolor,|,bold,italic,underline,sub,sup,strikethrough,advhr,charmap,|,link,unlink,anchor,pagebreak",
                theme_advanced_buttons2: "cut,copy,paste,pastetext,pasteword,undo,redo,cleanup,|,justifyleft,justifycenter,justifyright,bullist,numlist,|,insertdate,inserttime,search,preview,|,image,iboximage,media,profile,print,code",
                //theme_advanced_buttons3 : "",
                //theme_advanced_buttons4 : "",
                /*
                theme_advanced_buttons1 : "bold,italic,underline,striketough,|,justifyleft,justifycenter,justifyright,justifyfull,styleselect,formatselect,fontselect,fontsizeselect",
                ...
                theme_advanced_buttons3 : "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,image,media,profile,importword,advhr,|,ltr,rtl",
                theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak,|,fullscreen,code,print,iespell",
                */
                theme_advanced_blockformats: "p,address,pre,h1,h2,h3,h4,h5,h6",
                theme_advanced_toolbar_align: "left",
                theme_advanced_statusbar_location: "bottom",
                theme_advanced_fonts: (ed.settings.language == "zh" ? "宋体=宋体,黑体=黑体,楷体_GB2312=楷体_GB2312,仿宋_GB2312=仿宋_GB2312,隶书=隶书,Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats" : "Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats"),
        ...
        createControl: function(n, cf) {
            ...
            switch (n) {
                ...
                case "lineheight":
                    return this._createLineHeightSelect();
            }
        ...
        _createLineHeightSelect: function() {
            var t = this, ed = t.editor, c, i = 0, cl = [];
            lineheight = {};
            ...
            c = ed.controlManager.createListBox('lineheightselect', { title: '行高', onselect: function(v) {
                if (v)
                    ed.execCommand('LineHeight', false, v);
            }
            });

            if (c) {
                each(lineheight, function(v, k) {
                    c.add(k, v, { 'style': 'font-size:' + v });
                });
            }
        ...
        _nodeChanged: function(ed, cm, n, co) {
            var t = this, p, de = 0, v, c, s = t.settings, cl, fz, fn, fl;
            ...
            if (ed.settings.convert_fonts_to_spans) {
                ed.dom.getParent(n, function(n) {
                    if (n.nodeName === 'SPAN') {
                        ...
                        if (!fl && n.style.lineHeight)
                            fl = n.style.lineHeight;
                ...
                if (c = cm.get('lineheightselect')) {
                    v = ed.queryCommandValue('LineHeight');
                    c.select(function(iv) {
                        return iv == v;
                    });
                }
