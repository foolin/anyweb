...
public partial class AboutUs : AdminBase
{
    ...
    protected void ods3_Updated(object sender , ObjectDataSourceStatusEventArgs e)
    {
        ...
        {
            this.AddLog( Common.Common.EventID.Update , "修改关于我们" , "修改关于我们" );

            WebAgent.SuccAndGo( "保存成功." , "AboutUs.aspx" );
        }
        else
        {
            WebAgent.FailAndGo( "保存失败." , "AboutUs.aspx" ); 
        }
    }
}
