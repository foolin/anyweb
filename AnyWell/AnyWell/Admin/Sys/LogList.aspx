<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/InnerList.master" AutoEventWireup="true" CodeFile="LogList.aspx.cs" Inherits="Admin_Sys_LogList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphOpr" runat="Server">
    <div class="operation" id="LogOpr">
        ...
        <div class="opr-mbd">
            <ul>
                <li class="delFile"><a href="javascript:clearLog();">清空日志</a></li>
            </ul>
        </div>
    </div>
</asp:Content>
