<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RewardsGet.aspx.cs" Inherits="User_RewardsGet" %>

<div id="rew_<%=rewID %>">
    <form action="/User/RewardsSave.aspx?id=<%=QS("id") %>&rewid=<%=rewID %>&type=add"
    id="rew_form_<%=rewID %>" method="post">
