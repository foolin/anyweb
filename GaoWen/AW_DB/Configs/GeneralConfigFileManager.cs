...
namespace AnyWeb.AW.Configs
{
    ...
    /// 论坛基本设置管理类
    /// </summary>
    class GeneralConfigFileManager : AnyWeb.AW.Configs.DefaultConfigFileManager
    {
        ...
        public new static string ConfigFilePath
        {
            get
            {
                if (filename == null)
                {
                    filename = System.Web.HttpContext.Current.Server.MapPath("~/App_Data/general.config"); 
                }
