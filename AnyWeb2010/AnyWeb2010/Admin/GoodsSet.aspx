<%@ Page Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true" CodeFile="GoodsSet.aspx.cs" Inherits="Admin_GoodsSet" Title="商品促销" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" Runat="Server">
    <div class="pbd">
        <div class="part pt1 ptSidebar">
            <h2 class="PageTitle">设置商品促销时间</h2>
            <ul class="Help">
        ...
        <div class="part pt3">
            <div class="Mod DataList">
                        ...
                        <asp:Repeater ID="repGoodses" runat="server">
                            <ItemTemplate>
                                <tr align="center" class="editalt">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPromStartAt" CssClass="text" Width="70px" onclick="setday(this)" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtPromEndAt" CssClass="text" Width="70px" onclick="setday(this)" runat="server"></asp:TextBox>
                                    </td>
                                    <td>
                                        <%# Eval("fdGoodStockNum")%>
                                    </td>
                ...
                <div class="mft"></div>
                <div class="fi fiBtns">
                    <asp:Button ID="btnSave" CssClass="submit" OnClick="btnSave_Click" runat="server" Text="保存" />
