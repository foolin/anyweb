...
$("#wheather").html("<div class=\"imgArea\"><img src=\"images/weather/" + get_wea_photo(the_weather[1]) + "\" width=\"95\" height=\"95\" /></div><div class=\"infor\"><b>" + city_265 + "：" + the_weather[4] + "</b><br />" + the_weather[0] + "：" + the_weather[1] + "<br />" + the_weather[2] + "：" + the_weather[3] + "<br /></div><div class=\"date\" id=\"date\"></div>");
setDate();
