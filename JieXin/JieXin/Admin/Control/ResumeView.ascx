<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ResumeView.ascx.cs" Inherits="Admin_Control_ResumeView" %>
<style>
    body
    {
        margin: 0;
    ...
    <div class="resBox">
        <div class="Content">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 2px solid #3183AD">
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom: 1px dashed #CCCCCC;
                                ...
                                <tr>
                                    <td colspan="2">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td colspan="2" class="lblue">
                                                    Email：<span class="line"><a href="mailto:<%=bean.fdResuEmail %>"><%=bean.fdResuEmail %></a></span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="90" rowspan="4" class="tc gray">
                                        <img src="<%=bean.fdResuPhoto==""?"../images/img_personPhoto.png":bean.fdResuPhoto %>"
                                            width="90" height="110" /><br />
                                        ID:<%=bean.fdResuID %>
                                    </td>
                                </tr>
                            </table>
