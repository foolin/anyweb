...
namespace AnyWell.AW_DL
{
	public partial class AW_Site_dao : Dao_Base
	{
		public AW_Site_dao()
        {
            ...
            this._propFields = "fdSiteID,fdSiteName,fdSiteDesc,fdSiteSort,fdSiteCreateAt,fdSiteIsDel,fdSiteUrl,fdSitePath,fdSiteIndexTemplateID,fdSiteContentTemplateID,fdSiteListTemplateID";
        }
