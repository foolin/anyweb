...
public partial class Admin_Product_ProductList : PageAdmin
{
    ...
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        int recordCount = 0;
        List<AW_Product_bean> list = new AW_Product_dao().funcGetProductList( CurrentColumn, getChildren, field, orderBy, PN1.PageIndex, PN1.PageSize, out recordCount );
        if( list.Count == 0 )
        {
