...
public partial class Content_ArticleResume : AdminBase
{
        ...
        if (Request["id"] != null)
        {
            ...
            foreach (string ArticleID in Request["id"].Split(','))
            {
                ...
                if (ar != null)
                {
                    ...
                    log.EvenDesc = "还原文章" + ar.ArtiTitle + "成功.";
            ...
            agent.ResumeArticle(Request["id"].ToString());
        }
        WebAgent.SuccAndGo("还原成功", "ArticleRecycle.aspx");
    }
}
