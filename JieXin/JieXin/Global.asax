...
<script runat="server">
    ...
    string[] urls = { "/", "/index.aspx", "/login.aspx", "/import.aspx", "/User/Index.aspx", "/logout.aspx", "/search.aspx", "/initarea.aspx", "/register.aspx", "/notice.aspx", "/addfavorite.aspx", "/test.aspx" };
