...
var a_photo=new Array("qing.png","duoyun.png","yin.png","xiaoyu.png","zhenyu.png","dayu.png","leizhenyu.png");
...
//$("#wheather").html('<style type="text/css">body{text-align:center;font-size:12px;margin:0;padding:0;}\n#wea{width:168px;height:50px;margin:0 auto;}\nul{margin:0;padding:0;list-style:none;}\nul#wl{float:left;width:40px;text-align:center;}\n.wi{margin:' + lc + 'px 0 0 0;}\n.w2{margin-top:-10px;font-size:11px;font-family: Modern,"Arial Narrow",Verdana,Geneva;text-decoration:none;color:#0075EB;}\nul#wr{float:right;width:128px;}\nul#wr li{text-align:left;line-height:16px;padding:0 0 1px ' + wp + 'px;}\nul#wr li.lst{padding-bottom:0;}<\/style>');
//$("#wheather").html('<div id="wea" title="点击查看近3天天气情况" onclick="go_to(\'' + wea_link + '\');"><ul id="wl"><li class="wi"><img border="0" src="http://www.265.com/img/' + get_wea_photo(the_weather[1]) + '" alt="' + the_weather[1] + '" width="40"></li>' + slink + '</ul><ul id="wr"><li>' + city_265 + ':' + the_weather[4] + '</li><li>' + the_weather[0] + ':' + the_weather[1] + '</li><li class="lst">' + the_weather[2] + ':' + the_weather[3] + '</li></ul></div>');
$("#wheather").html("<div class=\"imgArea\"><img src=\"images/weather/" + get_wea_photo(the_weather[1]) + "\" width=\"95\" height=\"95\" /></div><div class=\"infor\"><b>" + city_265 + "：" + the_weather[4] + "</b><br />" + the_weather[4] + "：" + the_weather[1] + "<br />" + the_weather[2] + "：" + the_weather[3] + "<br /></div><div class=\"date\" id=\"date\"></div>");
setDate();
