<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/List.master" AutoEventWireup="true"
    CodeFile="ExhibitorRecycleList.aspx.cs" Inherits="Admin_Exhibitor_ExhibitorRecycleList" %>

<%@ Register Src="../Control/ExhibitorRecycleOperation.ascx" TagName="ExhibitorRecycleOperation"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphOpr" runat="Server">
    <uc1:ExhibitorRecycleOperation runat="server" />
