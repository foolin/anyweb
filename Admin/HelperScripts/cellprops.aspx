<%@ Page LANGUAGE="VBSCRIPT" CODEPAGE="936" %>
<html>
<head>
...
function getcolorfrommoondowner(currentcolor){
	...
	window.showModalDialog("color.aspx",window,"dialogHeight: 250px; dialogWidth: 520px; help: no;scroll: no; status: no");
...
var retCol
  bascol = showModalDialog("color.aspx",window,"center:yes;dialogHeight:320px;dialogWidth:300px;help:no;status:no");
            ...
            <td valign="middle"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  src="images/ftb/office2003/clrbox.gif" width=54 
              border=0></td>
                      </tr>
                      </tbody>
                    </table>
