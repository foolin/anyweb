<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="GoodsEdit.aspx.cs" Inherits="GoodsEdit" Title="商品管理" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
            ...
            <div class="inner">
                ...
                <asp:FormView ID="fv1" runat="server" DataKeyNames="ID" Width="100%" DataSourceID="ods3"
                    ...
                    <ItemTemplate>
                        <table class="iEditForm iEditBaseInf">
                            ...
                            <tr>
                                ...
                                <td rowspan="8" style="text-align: center; width: 226px; background-color: White;
                                    ...
                                    <img src='<%#(string)Eval("image")=="" ? "/images/wait.jpg":Eval("image").ToString().Replace("S_","")%>'
                        ...
                        <div class="iSubmit">
                            <button id="btnEdit" onclick="window.location='GoodsEdit.aspx?mode=update&gid=<%#Eval("ID")%>';"
                                type="button" class="submit">
                                编辑该商品</button>
                            <span style="display: <%#(bool)Eval("Recommend")==true? "":"none"%>">
                                <button id="btnComment" onclick="window.location='CommentList.aspx?tid=2&sid=<%#Eval("ID") %>';"
                                    type="button" class="submit">
                                    查看该商品评论</button></span>
                    ...
                    <EditItemTemplate>
                        <table class="iEditForm iEditBaseInf">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input" errmsg="请输入正确的商品名称" MaxLength="50"
                                        require="1" Width="308px" Text='<%#Bind("GoodsName") %>'></asp:TextBox>&nbsp;不超过50个汉字。
                                </td>
                            </tr>
                            <tr class="name">
                                <th>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMode" runat="server" Text='<%#Bind("Model")%>' CssClass="input"
                                        errmsg="请输入正确的商品型号" MaxLength="50" require="1" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <asp:DropDownList ID="drpType" runat="server" DataSourceID="ods4" DataValueField="ID"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSale" runat="server" Text='<%#Bind("Service")%>' CssClass="input"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOrder" runat="server" Text='<%#Bind("Order") %>' CssClass="input" require="1" errmsg="请输入正确的排序"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <div class="iSubmit">
                            <asp:Button ID="btnSave" runat="server" Text="保存商品" CommandName="Update" CssClass="submit">
                            </asp:Button>
                            <asp:Button ID="btnDelete" runat="server" Text="删除该商品" CommandName="Delete" CssClass="submit">
                            </asp:Button>
                    ...
                    <InsertItemTemplate>
                        <table class="iEditForm iEditBaseInf">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSale" runat="server" Text='<%#Bind("Service")%>' CssClass="input"
                                        TextMode="MultiLine" MaxLength="1000" Width="500px" Height="60px"></asp:TextBox>不超过1000个字。
                                </td>
                            </tr>
                            <tr>
                                <th>
    ...
    <asp:ObjectDataSource ID="ods3" runat="server" SelectMethod="GetGoodsByID" TypeName="Common.Agent.GoodsAgent"
        ...
        OnUpdated="ods3_Updated" OnUpdating="ods3_Updating" DataObjectTypeName="Common.Common.Goods"
        InsertMethod="AddGoods" UpdateMethod="UpdateGoods" DeleteMethod="GoodsDeletes"
