<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true"
    CodeFile="LinkList.aspx.cs" Inherits="Admin_Setting_LinkList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph2" runat="Server">
    <ul class="Opr">
        <li><a href="LinkAdd.aspx">添加链接</a></li>
    </ul>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
        ...
        $(document).ready(function() {
            $("#datas").tableDnD({
                onDrop: function(table, row) {
                    ...
                    var url = "LinkSort.aspx?id=" + tagId + "&previewid=" + previewId + "&nextid=" + nextId;
    ...
    <div class="Mod DataList">
        ...
        <div class="mbd">
            <table id="datas">
                ...
                <asp:Repeater ID="compRep" runat="server" EnableViewState="False">
                    <ItemTemplate>
                        <tr align="center" class="editalt" id="row_<%# Eval("fdLinkID")%>">
                            <td style="width: 30px;">
                                <input type="checkbox" name="ids" value="<%# Eval("fdLinkID")%>" />
                            </td>
                            <td style="text-align: left;" class="dragTd" title="拖动排序">
                                <a href="<%#Eval("fdLinkUrl") %>" target="_blank"><%#Eval("fdLinkName")%></a>
                            </td>
                            <td>
                                <a href="<%#Eval("fdLinkUrl") %>" target="_blank"><%#Eval( "fdLinkUrl" )%></a>
                            </td>
                            <td>
                                <a href="LinkEdit.aspx?id=<%# Eval("fdLinkID")%>">修改</a> <a href="LinkDel.aspx?id=<%# Eval("fdLinkID")%>"
        ...
        <button onclick="delLinks()" style="height: 28px;" type="button">
            批量删除</button>
    </div>
    <div>
        <ul class="Help">
