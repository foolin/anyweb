<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.master" AutoEventWireup="true"
    CodeFile="CompanyADEdit.aspx.cs" Inherits="Admin_CompanyADEdit" %>
    ...
    <div class="Mod Form MainForm" id="InfoEdit">
        ...
        <div class="mbd">
            ...
            <div class="fi">
                ...
                <sw:Validator ID="Validator1" ControlID="txtName" ValidateType="Required" ErrorText="请输入企业名称"
                    ErrorMessage="请输入企业名称" runat="server">
                </sw:Validator>
            </div>
            <div class="fi even">
                <label>
