...
public partial class Admin_Plugins_Exhibitor_ExhibitorList : PageAdmin
{
    protected void Page_Load( object sender, EventArgs e )
    {
        ...
        int recordCount = 0;
        List<AW_Exhibitor_bean> list = new AW_Exhibitor_dao().funcGetExhibitorList( int.Parse( drpSite.SelectedValue ), PN1.PageIndex, PN1.PageSize, out recordCount );
        if( list.Count > 0 )
        {
