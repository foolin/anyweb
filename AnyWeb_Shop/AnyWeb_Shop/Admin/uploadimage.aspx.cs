...
public partial class uploadimage : AdminBase
{
    ...
    private void UploadFile()
    {
        ...
        string imgPath = Server.MapPath(ShopInfo.DataPath + "\\images");
        ...
        url = this.ShopInfo.Url + ShopInfo.DataPath.Substring(1) + "/images/" + fileName.Substring(fileName.LastIndexOf('\\') + 1);
