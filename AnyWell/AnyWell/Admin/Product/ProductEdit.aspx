<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Master/Content.master" AutoEventWireup="true"
    CodeFile="ProductEdit.aspx.cs" Inherits="Admin_Product_ProductEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="mft">
        <button id="Saving" type="button" style="display: none;" disabled="disabled">
            正在保存</button>
        <asp:Button ID="btnSave" CssClass="button" runat="server" Text="保存产品" OnClick="btnSave_Click" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphOpr" runat="Server">
    <div class="operation" id="folder_desc">
        ...
        <div class="opr-mbd">
            <ul>
                <li>
                    <asp:CheckBox ID="chkDesc" runat="server" Text="自动生成描述" CssClass="checkbox" onclick="AutoDesc(this.checked);" />
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a id="picLink" href="<%=bean.fdProdImage %>" target="_blank" title="查看图片(右键删除图片)"
                            style="position: absolute; margin-top: 5px 0; <%=string.IsNullOrEmpty( bean.fdProdImage )?"display:none;": ""%>"
                            oncontextmenu="return delPic();">
                            <img src="../images/icons/col_Album.gif" alt="" /></a>
                        <input type="hidden" id="txtPic" name="txtPic" value="<%=bean.fdProdImage %>" />
                    </td>
                </tr>
                <tr>
                    <td>
